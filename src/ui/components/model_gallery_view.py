...
from PySide6.QtWidgets import (
    ...
    QFrame, QToolBar, QComboBox, QSizePolicy
)
from PySide6.QtCore import Qt, Signal, QSize
from PySide6.QtGui import QAction, QIcon, QPixmap, QImage, QColor, QPainter, QClipboard, QGuiApplication

from src.constants import VIEW_MODE, SORT_OPTIONS
...
class ModelGalleryView(QWidget):
    ...
    def init_ui(self):
        ...
        self.list_view.setHorizontalHeaderLabels(["Name", "Type", "Size", "Date", "Rating"])
        ...
        self.list_view.horizontalHeader().setSectionResizeMode(1, QHeaderView.ResizeToContents)
        self.list_view.horizontalHeader().setSectionResizeMode(2, QHeaderView.ResizeToContents)
        self.list_view.horizontalHeader().setSectionResizeMode(3, QHeaderView.ResizeToContents)
        self.list_view.horizontalHeader().setSectionResizeMode(4, QHeaderView.ResizeToContents)
        self.list_view.verticalHeader().setVisible(False)
        self.list_view.setAlternatingRowColors(True)
        self.list_view.horizontalHeader().setSortIndicatorShown(True)
        self.list_view.horizontalHeader().sortIndicatorChanged.connect(self.on_header_sort)
